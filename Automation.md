...
##Gulp
We are going to use Gulp for our automation framework. To be honest, I was going to switch to WebPack, but the React community has embraced WebPack as the defacto automation framework. So, there are plenty of examples online. Also I went with Gulp because the learning curve is bigger for WebPack and I don't want it to be a distraction. 
